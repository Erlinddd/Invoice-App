...
<Card.Header  >  <FontAwesomeIcon  style={{marginLeft:"10px"}} icon={faEdit}  size="lg"/> Edit Consumer</Card.Header>
...
<Form.Control  value={consumer.lastName} onChange={ onChange }  autoComplete="off"  required name="lastName" className="bg-dark text-white" type="text" placeholder="LastName" />
</Form.Group>
...
<Form.Control  value={consumer.city} onChange={onChange} required name="city" className="bg-dark text-white" type="text" placeholder="City" />
</Form.Group>
</Form.Row>
<Form.Row>
...
<FontAwesomeIcon icon={faSave} /> 
  {''}   Update  </Button> {""}
   ...
   <Button onClick={() => setConsumer('')}   className="btn btn-dark btn-block" type="reset">
   <FontAwesomeIcon icon={faUndo}/> Reset
   </Button>{"  "}

   <Button   onClick={handleClick} size="sm"  className="btn btn-dark btn-block" type="button">
