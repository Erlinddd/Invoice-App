...
export default function CreateUserPopUp({rajoniOnChange,data,onChange,handleFormSubmit,handleClose,open}) {
  
const {id,FirstName,LastName,Contact,City,Street,PostalCode,RajoniId}=data
    ...
    <div>
      ...
      >
        ...
        <form>
             ...
             <TextField id="Contact"     value={Contact} onChange={e=>onChange(e)} placeholder="Contact" label="Contact" variant="outlined" margin="dense" fullWidth />
             ...
             <div >
         <br/>
      <select className=" bg-white text-black  custom-select mr-sm-8" id="inlineFormCustomSelect" value={RajoniId} onChange={ rajoniOnChange }  >
