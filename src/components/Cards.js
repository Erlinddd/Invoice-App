      ...
      >
        ...
        <Card.Title>Create Article </Card.Title>
          ...
          <Link to="/lists" className="nav-link"> 
           <h2 style={{color:"white",textAlign:"center"}}> <AddShoppingCartIcon color="white" sx={{ fontSize: 40 }} /> </h2>
            </Link> 
          </Card.Text>
        </Card.Body>
      </Card>
      ...
      >
        ...
        <Card.Body>
          ...
          <Link to="/Welcome" className="nav-link"> 
           <h2 style={{color:"white",textAlign:"center"}}> <ReceiptIcon color="white" sx={{ fontSize: 40 }} /> </h2>
            </Link> 
          </Card.Text>
        </Card.Body>
      </Card>
      ...
      >
        ...
        <Card.Body>
          ...
          <Link to="/faturat" className="nav-link"> 
           <h2 style={{color:"white",textAlign:"center"}}> <AssessmentIcon color="white" sx={{ fontSize: 40 }} /> </h2>
            </Link> 
          </Card.Text>
        </Card.Body>
      </Card>
