  ...
  return (
    ...
    <Cards/>
              ...
              <div style={nav}>
                ...
                <PrivateRoutes
                  path="/faturaCard/:id"
                  component={(props) => <FaturaCard {...props} />}
                />
                <PrivateRoutes
                  path="/add"
                ...
                <PrivateRoutes
                  ...
                  component={(props) => <ArticleLists {...props} />}
                />
                <PrivateRoutes
                  path="/edit/:id"
                  component={(props) => <AddArticle {...props} />}
                ...
                />
                <PrivateRoutes
                  path="/editt/bleresi/:id"
                  component={(props) => <EditConsumer {...props} />}
                />
                <PrivateRoutes
                  path="/faturat"
                  component={(props) => <Searchdata {...props} />}
                />
                <PrivateRoutes
                  exact
                  path="/cards"
